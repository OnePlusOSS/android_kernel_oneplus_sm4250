...
extern int oneplus_dimlayer_dither_threshold;
extern int oneplus_dimlayer_dither_bitdepth;
						  ...
						  void *dither_cfg, int len)
{
	...
	if (oneplus_get_panel_brightness_to_alpha() < oneplus_dimlayer_dither_threshold)
		return -EINVAL;
