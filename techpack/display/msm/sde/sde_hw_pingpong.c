...
#include "../dsi/dsi_oneplus_support.h"
...
extern int oneplus_request_power_status;
		...
		struct sde_hw_tear_check *te)
{
...

	{
		...
		if((oneplus_request_power_status == ONEPLUS_DISPLAY_POWER_DOZE) || (oneplus_request_power_status == ONEPLUS_DISPLAY_POWER_DOZE_SUSPEND)) {
