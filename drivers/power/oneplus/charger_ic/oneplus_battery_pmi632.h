...
#ifndef __ONEPLUS_BATTERY_QCOM_PMI632_H_
#define __ONEPLUS_BATTERY_QCOM_PMI632_H_
...
#define FIRST_PROTECT_CONNECTOR_TEMP 60
#define SECOND_PROTECT_INTERVAL_TEMP 15
#define SECOND_PROTECT_CONNECTOR_TEMP 45
...
struct smb_charger {
	...
	struct delayed_work	onepluschg_monitor_work;
	...
	int			first_protect_connector_temp;
	int			second_protect_interval_temp;
	int			second_protect_connector_temp;
	int			third_protect_base_temp;
	int			pre_temp;
	int			current_temp;
	int			third_protect_rise_rate;
	bool			input_suspend_locked;
};
...
#endif /* __ONEPLUS_BATTERY_QCOM_PMI632_H_ */
