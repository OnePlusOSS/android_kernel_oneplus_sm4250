...
enum limit_type {
	...
	//means all nodes have it's own limit,format is : tx * rx,horizontal for rx data,vertical for tx data
	LIMIT_TYPE_TX_RX_DATA				= 0x03,
	//means all nodes have it's own limit,format is : tx + rx
	LIMIT_TYPE_SLEF_TX_RX_DATA			= 0x04,
	//means all nodes have it's own limit,format is : tx + tx + rx + rx
	LIMIT_TYPE_SLEF_TX_RX_DATA_DOUBLE	= 0x05,
/***************************** Novatek *********************************/
