...
struct adapter_struct {
    ...
    enum charger_type adapter_chg_type;
};
...
#else
	int warp_strategy1_batt_high_temp3;
	int warp_strategy1_batt_high_temp4;
	int warp_strategy1_batt_low_temp3;
	int warp_strategy1_batt_low_temp4;
	int warp_strategy1_high_current3;
	int warp_strategy1_high_current4;
	int warp_strategy1_high_current5;
	int warp_strategy2_batt_high_temp0;
	int warp_strategy2_batt_high_temp1;
	int warp_strategy2_batt_high_temp2;
	int warp_strategy2_batt_high_temp3;
	int warp_strategy2_batt_high_temp4;
	int warp_strategy2_batt_low_temp0;
	int warp_strategy2_batt_low_temp1;
	int warp_strategy2_batt_low_temp2;
	int warp_strategy2_batt_low_temp3;
	int warp_strategy2_batt_low_temp4;
	int warp_strategy2_high_current0;
	int warp_strategy2_high_current1;
	int warp_strategy2_high_current2;
	int warp_strategy2_high_current3;
	int warp_strategy2_high_current4;
	int warp_strategy2_high_current5;
	int warp_strategy1_skin_high_temp1;
	int warp_strategy1_skin_high_temp2;
	int warp_strategy1_skin_low_temp2;
	int warp_strategy1_skin_low_temp1;
	int warp_strategy1_skin_current3;
	int warp_strategy1_skin_current2;
	int warp_strategy1_skin_current1;
